...
export default class Items {
	...
	////// 使用道具 //////
	useItem(itemId, noRoute, callback) {
	...
	////// 卸下 //////
	unloadEquip(equipType, callback) {
	...
	compareEquipment(compareEquipId, beComparedEquipId) {
	...
	////// 实际换装的效果 //////
	_loadEquipEffect(equipId, unloadEquipId) {
		// 比较能力值
	...
	_realLoadEquip(type, loadId, unloadId, callback) {
	...
	////// 设置装备属性 //////
	setEquip(equipId, valueType, name, value, operator, prefix) {
		var equip = core.material.items[equipId];
